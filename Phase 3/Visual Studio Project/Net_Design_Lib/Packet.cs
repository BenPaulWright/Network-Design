...
namespace Net_Design_Lib
{
    ...
    public class Packet
    {
        ...
        public Packet(byte sequenceNumber, byte[] packetContent, PacketType packetType = PacketType.Data)
        {
            ...
            Raw[sequenceNumberIndex] = sequenceNumber;
        ...
        public byte SequenceNumber
        {
            get
            {
                return Raw[sequenceNumberIndex];
            }
            set
            {
                Raw[sequenceNumberIndex] = value;
            }
        }
